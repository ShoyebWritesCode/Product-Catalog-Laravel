...
<div id="popupContent" class="flex justify-between space-x-4 container">
    ...
    <div id="shippingFormContainer" class="w-1/2 bg-white overflow-hidden shadow-sm sm:rounded-lg p-3 container">
    ...
    <div id="billingFormContainer" class="w-1/2 bg-white overflow-hidden shadow-sm sm:rounded-lg p-3 container">
